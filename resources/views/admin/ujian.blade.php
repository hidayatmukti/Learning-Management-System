                  ...
                  <tr>
                   ...
                   <div class="modal fade" id="exampleModals{{$i}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <form method="post" action="{{route('delete_ujian')}}">
                        @csrf
                    ...
                    <div class="modal fade" id="exampleModalss{{$i}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                      <form method="post" action="{{route('edit_ujian')}}" enctype="multipart/form-data">
                      @csrf
                        <div class="modal-content">
                          <div class="modal-header">
                        ...
                        <div class="modal-body">
                          <div class="form-group row" style="margin-left:-120px;">
                            ...
                            <div class="col-sm-6">
                              <input type="text" name="nama" class="form-control" placeholder="" value="{{$d->nama_ujian}}" required>
                            </div>
                          </div> 
                          <div class="form-group row" style="margin-left:-120px;">
                          ...
                          <div class="form-group row" style="margin-left:-120px;">
                            <label class="col-sm-2 col-form-label" style="margin-left: 150px;">Durasi</label>
                            <div class="col-sm-6">
                              <input type="time" name="durasi" class="form-control" placeholder="" value="{{$d->durasi}}" required>
                            </div>
                          </div> 
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
  <form method="post" action="{{ route('add_ujian') }}" enctype="multipart/form-data">
  @csrf
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        ...
        <div class="form-group row" style="margin-left:-120px;">
          <label class="col-sm-2 col-form-label" style="margin-left: 150px;">Tanggal Pengerjaan</label>
          <div class="col-sm-6">
        ...
        <div class="form-group row" style="margin-left:-120px;">
          <label class="col-sm-2 col-form-label" style="margin-left: 150px;">Durasi</label>
          <div class="col-sm-6">
            <input type="time" name="durasi" class="form-control" placeholder="" required>
          </div>
        </div> 
